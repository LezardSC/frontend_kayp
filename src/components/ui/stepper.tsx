      ...
      >
        <div
          ...
          className={cn(
            ...
            'flex items-center',
            variant === 'simple' &&
              'border-s-[3px] py-2 ps-3 data-[active=true]:border-blue-500',
    ...
    return (
      <div
        ...
        className={cn(
          ...
          variant === 'simple' &&
            'flex-1 flex-col border-t-[3px] data-[active=true]:border-blue-500',
          isCompletedStep &&
            '[&:not(:last-child)]:after:bg-blue-500 [&:not(:last-child)]:after:data-[invalid=true]:bg-destructive',
  ...
  return (
    <Button
      ...
      className={cn(
        ...
        'data-[active=true]:border-blue-500 data-[active=true]:bg-blue-500 data-[active=true]:text-primary-foreground dark:data-[active=true]:text-primary',
